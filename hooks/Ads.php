<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Ads' table. 
	...
	*/
	...
	function Ads_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Ads_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Ads_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['NickName'], $data['Sex'], $data['Age'], $data['Status'], $data['InterestedIn'], $data['Pic1'], $data['Pic2'], $data['Pic3'], $data['MoreInfo'], $data['Contact']
	...
	*/
	...
	function Ads_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['CreatedOn'], $data['NickName'], $data['Sex'], $data['Age'], $data['Status'], $data['InterestedIn'], $data['Pic1'], $data['Pic2'], $data['Pic3'], $data['MoreInfo'], $data['Contact']
	...
	*/
	...
	function Ads_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['NickName'], $data['Sex'], $data['Age'], $data['Status'], $data['InterestedIn'], $data['Pic1'], $data['Pic2'], $data['Pic3'], $data['MoreInfo'], $data['Contact']
	...
	*/
	...
	function Ads_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['CreatedOn'], $data['NickName'], $data['Sex'], $data['Age'], $data['Status'], $data['InterestedIn'], $data['Pic1'], $data['Pic2'], $data['Pic3'], $data['MoreInfo'], $data['Contact']
	...
	*/
	...
	function Ads_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Ads_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Ads_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Ads_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Ads_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Ads_batch_actions(&$args){
