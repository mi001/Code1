<?php
	...
	$schema = array(   
		'Ads' => array(   
			...
			'CreatedOn' => array('appgini' => 'VARCHAR(40) '),
			'NickName' => array('appgini' => 'VARCHAR(40) '),
			'Sex' => array('appgini' => 'VARCHAR(40) '),
			'Age' => array('appgini' => 'INT unsigned '),
			'Status' => array('appgini' => 'VARCHAR(40) '),
			'InterestedIn' => array('appgini' => 'VARCHAR(40) '),
			'Pic1' => array('appgini' => 'VARCHAR(40) '),
			'Pic2' => array('appgini' => 'VARCHAR(40) '),
			'Pic3' => array('appgini' => 'VARCHAR(40) '),
			'MoreInfo' => array('appgini' => 'VARCHAR(40) '),
